...
// APIkey = 3e3e75aaa197fd2ccf6de02d77ab992d
...
window.addEventListener('DOMContentLoaded', async function(event) {
    ...
    let url = 'https://api.themoviedb.org/3/movie/now_playing?api_key=3e3e75aaa197fd2ccf6de02d77ab992d&language=en-US'
    ...
    for (let i=0;i<moviesList.length;i++) {
        ...
        <div class="w-1/5 p-4 movie-${movieID} ${opacity}">
            ...
            <a href="#" class="watched-button block text-center text-white bg-green-500 mt-4 px-4 py-2 rounded">Already watched dis</a>
        </div>
        `)
